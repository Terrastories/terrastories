...
var Map = function (_Component) {
  ...
  function Map(props) {
    ...
    Object.defineProperty(_this, 'flyToandSetState', {
      enumerable: true,
      writable: true,
      value: function value(event) {
        _this.setState({ pointCoords: event.pointCoords });
      }
    });
  ...
  _createClass(Map, [{
    ...
    value: function componentDidMount() {
      ...
      fetch('/points.json').then(function (response) {
        return response.json();
      }).then(function (data) {
        _this2.setState({ points: data });
      }).catch(function (error) {
        return console.log(error);
      });

      // @NOTE: MAKE SURE ARRAY IS [LONGITUDE, LATITUDE]
      var bounds = [[-60.80409032, 0.3332811], //southwest
      ...
      if (this.state.points) {
        this.map.on('load', function () {
          ...
          _this2.state.points.features.forEach(function (marker) {
            console.log(marker.properties);
            // create a HTML element for each feature
            var el = document.createElement('div');
            el.className = 'marker';
            el.id = 'storypoint' + marker.id;
            var popup = new mapboxgl.Popup({ offset: 15 }).setHTML('<h1>' + marker.properties.title + '</h1>' + '<h2>' + marker.properties.region + '</h2>');
            // make a marker for each feature and add to the map
            new mapboxgl.Marker(el).setLngLat(marker.geometry.coordinates).setPopup(popup) // sets a popup on this marker
            .addTo(_this2.map);
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { ref: function ref(el) {
        ...
        onChange: this.flyToandSetState,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(/*! react */ 0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__StoryList__ = __webpack_require__(/*! ./StoryList */ 6);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Card = function (_PureComponent) {
  ...
  function Card(props) {
    ...
    _this.handleTray = _this.handleTray.bind(_this);
    return _this;
  }

  _createClass(Card, [{
    key: "handleTray",
    value: function handleTray() {
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        { className: this.state.isToggleOn ? 'card onCanvas' : 'card offCanvas' },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "div",
          { className: "tab", onClick: this.handleTray.bind('card offCanvas') },
          "\u25BA"
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "div",
          { className: "closeMe", onClick: this.handleTray.bind('card offCanvas') },
          "\xD7"
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "div",
          { className: "card--logo" },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img", { src: "assets/logocombo.svg", alt: "Terrastories" })
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "form",
          { name: "search", className: "card--search", method: "post" },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "search", placeholder: "Search Terrastories", className: "search--field" })
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "div",
          { className: "card--nav" },
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__StoryList__["default"], { stories: this.props.stories, onStoryClick: this.props.onCardClick }),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "div",
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(/*! react */ 0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(/*! prop-types */ 11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__StoryMedia__ = __webpack_require__(/*! ./StoryMedia */ 7);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var StoryList = function (_PureComponent) {
  _inherits(StoryList, _PureComponent);

  function StoryList() {
    _classCallCheck(this, StoryList);

    return _possibleConstructorReturn(this, (StoryList.__proto__ || Object.getPrototypeOf(StoryList)).apply(this, arguments));
  }
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              "li",
              {
                ...
                onClick: function onClick(_) {
                  return _this2.props.onStoryClick([story.point.lng, story.point.lat]);
                }
              },
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: "speakers" },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img", { src: story.speaker.picture_url, alt: story.speaker.name, title: story.speaker.name })
              ),
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: "container" },
                ...
                story.media && story.media.map(function (file) {
                  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__StoryMedia__["default"], { file: file });
                })
              )
            );
          })
...
Object.defineProperty(StoryList, "propTypes", {
  enumerable: true,
  writable: true,
  value: {
    stories: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.array
  }
});
...
var StoryMedia = function (_PureComponent) {
  _inherits(StoryMedia, _PureComponent);

  function StoryMedia() {
    _classCallCheck(this, StoryMedia);

    return _possibleConstructorReturn(this, (StoryMedia.__proto__ || Object.getPrototypeOf(StoryMedia)).apply(this, arguments));
  }

  _createClass(StoryMedia, [{
    key: "renderAudio",
    value: function renderAudio() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "audio",
        { id: "audio-player" + file.id, controls: true },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("source", { src: file.url, type: file.blob.content_type })
      );
    }
  }, {
    key: "renderVideo",
    ...
    key: "render",
    value: function render() {
      return this.props.file.blob.content_type.indexOf("video") !== -1 ? this.renderVideo() : this.renderAudio();
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (StoryMedia);
...
var IntroPopup = function (_PureComponent) {
  _inherits(IntroPopup, _PureComponent);

  function IntroPopup(props) {
    _classCallCheck(this, IntroPopup);

    var _this = _possibleConstructorReturn(this, (IntroPopup.__proto__ || Object.getPrototypeOf(IntroPopup)).call(this, props));

    Object.defineProperty(_this, 'handleIntroPopup', {
      enumerable: true,
      writable: true,
  ...
  _createClass(IntroPopup, [{
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { className: this.state.isPopped ? 'intro-card isShown' : 'intro-card isHidden' },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'h2',
          null,
          'Introduction'
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          { className: 'intro-card--actions' },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'span',
            { className: 'count', onClick: this.handleIntroPopup },
            'Close'
          )
        )
      );
...
/* harmony default export */ __webpack_exports__["default"] = (IntroPopup);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(/*! react */ 0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Map__ = __webpack_require__(/*! ./Map */ 4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Card__ = __webpack_require__(/*! ./Card */ 5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__IntroPopup__ = __webpack_require__(/*! ./IntroPopup */ 8);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    Object.defineProperty(_this, 'setPointCoords', {
      enumerable: true,
      writable: true,
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        null,
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Map__["default"], { pointCoords: this.state.coords }),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Card__["default"], { stories: this.props.stories, onCardClick: this.setPointCoords }),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__IntroPopup__["default"], null)
      );
    }
  }]);
...
var _assign = __webpack_require__(/*! object-assign */ 1);
var checkPropTypes = __webpack_require__(/*! prop-types/checkPropTypes */ 2);
var schedule = __webpack_require__(/*! schedule */ 15);
var tracing = __webpack_require__(/*! schedule/tracing */ 17);
...
if (false) {
  ...
  module.exports = __webpack_require__(/*! ./cjs/schedule.development.js */ 16);
}
...
if (false) {
  ...
  module.exports = __webpack_require__(/*! ./cjs/schedule-tracing.development.js */ 18);
}
...
var constructorFromGlobal = __webpack_require__(/*! ./src/getConstructor/fromGlobal */ 19)
...
var fromGlobal = __webpack_require__(/*! ./fromGlobal */ 19)
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-bc0d53084038b628e6bf.js.map