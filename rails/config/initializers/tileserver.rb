...
Rails.application.config.default_mapbox_token = ENV["DEFAULT_MAPBOX_TOKEN"]
Rails.application.config.default_map_style = ENV["DEFAULT_MAP_STYLE"] || "mapbox://styles/mapbox/streets-v11"
