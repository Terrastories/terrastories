...
export default class Map extends Component {
  constructor(props) {
    ...
    mapboxgl.accessToken = "pk.eyJ1IjoiYXRsYXMtdXNlciIsImEiOiJjam9yNW5sNGgwMDAwMGhuNWZmNDU2dzdzIn0.H-BNTbjyiPZ7qNl1NM1U-A"
    mapboxgl.config.API_URL = "https://localhost:9021/" // needed for running atlas. This is assumed when using apbox.com
  }
  ...
  componentDidMount() {
    ...
    this.map = new mapboxgl.Map({
      ...
      style: "mapbox://styles/atlas-user/cjpvc5ane002y01mw9cv9yu8j",
      center: [-108, 38.5],
      zoom: 3.5,
      maxBounds: bounds
    });
