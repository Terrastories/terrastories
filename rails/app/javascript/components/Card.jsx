	...
	renderUserInformation = () => {
		if (this.props.user && this.props.user.role === "editor") {
			return (
				<ul>
					<li>
						{I18n.t("hello")} {this.props.user.email} (
						<a href={`/${I18n.currentLocale()}`}>{I18n.t("back_to_welcome")}</a>
						)
					</li>
					<li>
						<a href={`/admin?locale=${I18n.currentLocale()}`}>
							{I18n.t("admin_page")}
						</a>
					</li>
				</ul>
			...
			<div
				className={
					this.state.isToggleOn
						? "cardContainer onCanvas"
						: "cardContainer offCanvas"
				}
			>
				...
				<div className="card">
					<div className="bar">
						...
						<StoryList
							...
							refProps={this.props.refProp}
						/>

						<div className="card--tasks">{this.renderUserInformation()}</div>
					</div>
				</div>
			</div>
		);
