		...
		return (
			...
			>
				<li
					...
					style={style}
				>
					<div className="speakers" ref={index == 0 ? this.props.refProps : ""}>
						{story.speakers.length === 1 && (
							<div>
								<img
									src={story.speakers[0].picture_url}
									alt={story.speakers[0].name}
									title={story.speakers[0].name}
								/>
						...
						{story.speakers.length > 1 && (
							<p style={{ fontWeight: "bold" }}>
								{" "}
								{this.getStorySpeakerNames(story)}{" "}
							</p>
						)}
					</div>
